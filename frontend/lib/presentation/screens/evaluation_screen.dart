          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.treatment,
                          style: AppText.bodyLg(color: AppColors.onBackground).copyWith(fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                  ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _isControlled == true ? AppColors.primaryContainer : AppColors.primaryContainer.withOpacity(0.3),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: _isControlled == true ? AppColors.primary : Colors.transparent,
                          width: 2,
                        ),
                      ),
                      child: Column(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.symmetric(vertical: 20),
                      decoration: BoxDecoration(
                        color: _isControlled == false ? AppColors.errorContainer : AppColors.errorContainer.withOpacity(0.3),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: _isControlled == false ? AppColors.error : Colors.transparent,
                          width: 2,
                        ),
                      ),
                      child: Column(
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: _isControlled == null ? null : () {
