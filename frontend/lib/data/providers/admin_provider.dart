...
class AdminProvider extends ChangeNotifier {
  ...
  void setFiltroActivo(bool? activo) {
  ...
  void setVerEliminados(bool valor) {
    _verEliminados = valor;
    cargarUsuarios();
  }
  ...
  Future<void> cargarTodosLotes({String? propietarioId}) async {
    _setLoading(true);
    try {
      _lotes = await _adminService.listarTodosLotes(propietarioId: propietarioId);
      _error = null;
    } catch (e) {
      _error = _mensajeError(e);
    } finally {
