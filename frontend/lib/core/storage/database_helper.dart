...
class DatabaseHelper {
  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    ...
    if (oldVersion < 3) {
      ...
      await db
          .execute('ALTER TABLE $tableLotes ADD COLUMN cultivoActualId TEXT');
    ...
    if (oldVersion < 4) {
      ...
      await db.execute(
          'ALTER TABLE $tableFertilizacion ADD COLUMN fertilizanteId TEXT');
    }
    if (oldVersion < 5) {
      // Sprint 3: Agregar serverId, syncError, y campos 'Otro'
      await db
          .execute('ALTER TABLE $tableSiembras ADD COLUMN cultivoOtro TEXT');
      ...
      await db.execute(
          'ALTER TABLE $tableFertilizacion ADD COLUMN fertilizanteOtro TEXT');
      await db
          .execute('ALTER TABLE $tableFertilizacion ADD COLUMN serverId TEXT');
      await db
          .execute('ALTER TABLE $tableFertilizacion ADD COLUMN syncError TEXT');
      ...
      await db
          .execute('ALTER TABLE $tableTratamientos ADD COLUMN serverId TEXT');
      await db
          .execute('ALTER TABLE $tableTratamientos ADD COLUMN syncError TEXT');

      await db
          .execute('ALTER TABLE $tableObservaciones ADD COLUMN serverId TEXT');
      await db
          .execute('ALTER TABLE $tableObservaciones ADD COLUMN syncError TEXT');
    }
    if (oldVersion < 6) {
    ...
    if (oldVersion < 8) {
      try {
        await db.execute(
            'ALTER TABLE $tableLotes ADD COLUMN isPendingSync INTEGER NOT NULL DEFAULT 0');
      } catch (_) {}
    }
    if (oldVersion < 9) {
    ...
    if (oldVersion < 10) {
      try {
        await db.execute(
            'ALTER TABLE $tableObservaciones ADD COLUMN fotoPath TEXT');
      } catch (_) {}
    }
    if (oldVersion < 11) {
  ...
  Future<void> _seedCatalogos(Database db) async {
    ...
    final existing =
        await db.rawQuery('SELECT COUNT(*) as c FROM $tableCatMunicipios');
    ...
    final cultivos = [
      {
        ...
        'nombre': 'Banano',
        'categoria': 'Fruta',
        'descripcion': 'Cultivo principal de la Zona Bananera'
      },
      {
        'id': 'cul-002',
        'nombre': 'Palma de aceite',
        'categoria': 'Oleaginosa',
        'descripcion': 'Palma africana para extracción de aceite'
      },
      {
        'id': 'cul-003',
        'nombre': 'Café',
        'categoria': 'Bebida',
        'descripcion': 'Café arábica de la Sierra Nevada'
      },
      {
        'id': 'cul-004',
        'nombre': 'Cacao',
        'categoria': 'Bebida',
        'descripcion': 'Cacao fino de aroma'
      },
      {
        'id': 'cul-005',
        'nombre': 'Arroz',
        'categoria': 'Cereal',
        'descripcion': 'Arroz paddy riego y secano'
      },
      {
        'id': 'cul-006',
        'nombre': 'Maíz',
        'categoria': 'Cereal',
        'descripcion': 'Maíz tradicional y tecnificado'
      },
      {
        'id': 'cul-007',
        'nombre': 'Yuca',
        'categoria': 'Tubérculo',
        'descripcion': 'Yuca para consumo y agroindustria'
      },
      {
        'id': 'cul-008',
        'nombre': 'Mango',
        'categoria': 'Fruta',
        'descripcion': 'Mango de azúcar, Tommy, Keitt'
      },
      {
        'id': 'cul-009',
        'nombre': 'Tomate',
        'categoria': 'Hortaliza',
        'descripcion': 'Tomate bajo invernadero y a campo abierto'
      },
      {
        'id': 'cul-010',
        'nombre': 'Ají',
        'categoria': 'Hortaliza',
        'descripcion': 'Ají dulce y picante'
      },
      {
        'id': 'cul-011',
        'nombre': 'Plátano',
        'categoria': 'Fruta',
        'descripcion': 'Plátano hartón y dominico'
      },
      {
        'id': 'cul-012',
        'nombre': 'Sorgo',
        'categoria': 'Cereal',
        'descripcion': 'Sorgo para alimentación animal'
      },
      {
        'id': 'cul-013',
        'nombre': 'Algodón',
        'categoria': 'Fibra',
        'descripcion': 'Algodón upland'
      },
      {
        'id': 'cul-014',
        'nombre': 'Frijol',
        'categoria': 'Leguminosa',
        'descripcion': 'Frijol zaragoza y caupí'
      },
      {
        'id': 'cul-015',
        'nombre': 'Aguacate',
        'categoria': 'Fruta',
        'descripcion': 'Aguacate Hass y criollo'
      },
      {
        'id': 'cul-016',
        'nombre': 'Limón',
        'categoria': 'Cítrico',
        'descripcion': 'Limón Tahití'
      },
      {
        'id': 'cul-017',
        'nombre': 'Naranja',
      ...
      },
      {
        ...
        'nombre': 'Guayaba',
        'categoria': 'Fruta',
        'descripcion': 'Guayaba pera y agria'
      },
      {
        'id': 'cul-019',
        'nombre': 'Papaya',
        'categoria': 'Fruta',
        'descripcion': 'Papaya maradol'
      },
      {
        'id': 'cul-020',
        'nombre': 'Ñame',
        'categoria': 'Tubérculo',
        'descripcion': 'Ñame espino y diamante'
      },
    ];
    ...
    final plagas = [
      {
        ...
        'cultivosAfectados': 'Banano, Plátano'
      },
      {
        'id': 'pla-002',
      ...
      },
      {
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Hojas con perforaciones irregulares, presencia de excrementos en el cogollo, larvas verdes con cabeza oscura.',
        'cultivosAfectados': 'Maíz, Sorgo, Arroz'
      },
      {
        'id': 'pla-004',
        'nombre': 'Mosca blanca',
      ...
      },
      {
        ...
        'cultivosAfectados': 'Mango, Aguacate, Banano, Plátano, Cacao'
      },
      {
        'id': 'pla-006',
        ...
        'severidadTipica': 'critica',
        'sintomas':
            'Perforación circular en cereza/grano de café, granos vanos o dañados. Reduce calidad y peso.',
        'cultivosAfectados': 'Café'
      },
      {
        'id': 'pla-007',
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Manchas amarillo-naranja con polvo en el envés de las hojas, defoliación severa, pérdida de producción.',
        'cultivosAfectados': 'Café'
      },
      {
        'id': 'pla-008',
        ...
        'sintomas':
            'Manchas plateadas en hojas and frutos, puntos negros (excrementos), deformación de frutos jóvenes.',
      ...
      },
      {
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Galerías o canales serpenteantes y blanquecinos en las hojas por alimentación de las larvas.',
      ...
      },
      {
        ...
        'cultivosAfectados': 'Maíz, Frijol, Hortalizas, Cítricos'
      },
      {
        'id': 'pla-011',
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Marchitez repentina del follaje durante las horas más calurosas del día sin amarillamiento previo, pudrición vascular.',
        'cultivosAfectados': 'Tomate, Papa, Berenjena, Plátano'
      },
      {
        'id': 'pla-012',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Corte semicircular de hojas y defoliación rápida de ramas completas.',
        'cultivosAfectados': 'Yuca, Cítricos, Cacao, Café, Frutales'
      },
      {
        'id': 'pla-013',
        'nombre': 'Mildiu',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Manchas amarillentas en el haz de las hojas y moho grisáceo o blanquecino en el envés en condiciones de alta humedad.',
      ...
      },
      {
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Manchas necróticas café-negras de aspecto húmedo en hojas y tallos, pudrición húmeda del fruto y tubérculos.',
      ...
      },
      {
        ...
        'cultivosAfectados': 'Tomate, Banano, Plátano, Flores, Frijol'
      },
      {
        'id': 'pla-016',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Moho gris velloso sobre flores, hojas y frutos, provocando pudrición blanda.',
      ...
      },
      {
        ...
        'cultivosAfectados': 'Tomate, Pimentón, Cítricos'
      },
      {
        'id': 'pla-018',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Manchas foliares necróticas oscuras, a menudo rodeadas de un halo amarillo, muerte regresiva de brotes.',
      ...
      },
      {
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Flores, hojas y ramas que se marchitan rápidamente, se tornan negras y toman aspecto de quemadas por fuego.',
      ...
      },
      {
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Agallas/nudos en raíces, plantas raquíticas, marchitamiento aun con suelo húmedo, amarillamiento general.',
      ...
      },
      {
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Lesiones necróticas oscuras en las raíces secundarias, reducción del sistema radicular y retraso en el crecimiento.',
        'cultivosAfectados': 'Maíz, Plátano, Café, Papa'
      },
      {
        'id': 'pla-022',
        'nombre': 'Grama',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Maleza perenne de cobertura densa y rápida expansión por estolones, compite agresivamente por agua y nutrientes.',
      ...
      },
      {
        ...
        'sintomas':
            'Hierba de crecimiento rápido en zonas húmedas y sombreadas, compite con plántulas de hortalizas.',
        'cultivosAfectados': 'Hortalizas, Frutales'
      },
      {
        'id': 'pla-025',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Daño por roedura en tallos, raíces y frutos, pérdida de grano almacenado o en campo.',
        'cultivosAfectados': 'Maíz, Arroz, Hortalizas, Cacao'
      },
      {
        'id': 'pla-026',
        'nombre': 'Paloma común',
        ...
        'severidadTipica': 'baja',
        'sintomas':
            'Consumo de semillas recién sembradas y frutos maduros, contaminación foliar con excrementos.',
        'cultivosAfectados': 'Maíz, Sorgo, Arroz, Frutas'
      },
      {
        'id': 'pla-027',
        'nombre': 'Fusarium R4T',
        ...
        'severidadTipica': 'critica',
        'sintomas':
            'Amarillamiento de hojas viejas, marchitamiento, pudrición vascular oscura en el rizoma. Enfermedad de cuarentena en Colombia.',
        'cultivosAfectados': 'Banano, Plátano'
      },
      {
        'id': 'pla-028',
        ...
        'severidadTipica': 'critica',
        'sintomas':
            'Marchitamiento súbito de plantas adultas, pudrición vascular con exudado bacteriano, fruto con pudrición seca interna.',
        'cultivosAfectados': 'Plátano, Banano'
      },
      {
        'id': 'pla-029',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Manchas concéntricas con anillos concéntricos en hojas viejas, defoliación ascendente.',
      ...
      },
      {
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Mosaico amarillo y verde en hojas, deformación del follaje, reducción de tamaño de raíces.',
      ...
      },
      {
        ...
        'severidadTipica': 'alta',
        'sintomas':
            'Maleza perenne de hoja angosta, propagación por tubérculos subterráneos, competencia agresiva.',
        'cultivosAfectados': 'Todos los cultivos'
      },
      {
        'id': 'pla-032',
        ...
        'severidadTipica': 'media',
        'sintomas':
            'Maleza anual de hoja ancha con espinas, crecimiento rápido, hospedera de plagas.',
        'cultivosAfectados': 'Maíz, Frijol, Hortalizas'
      },
    ];
    ...
    final fertilizantes = [
      {
        ...
        'dosisRecomendadaKgHa': 150.0,
        'descripcion': 'Fuente concentrada de nitrógeno'
      },
      {
        'id': 'fer-002',
        'nombre': 'DAP',
        ...
        'presentacion': 'Granulado',
        'dosisRecomendadaKgHa': 100.0,
        'descripcion': 'Fosfato diamónico, arranque de cultivos'
      },
      {
        'id': 'fer-003',
        ...
        'presentacion': 'Granulado',
        'dosisRecomendadaKgHa': 120.0,
        'descripcion': 'Fuente de potasio para fructificación'
      },
      {
        'id': 'fer-004',
        'nombre': 'Triple 15',
        ...
        'presentacion': 'Granulado',
        'dosisRecomendadaKgHa': 200.0,
        'descripcion': 'Fórmula balanceada NPK'
      },
      {
        'id': 'fer-005',
        'nombre': '10-30-10',
        ...
        'presentacion': 'Granulado',
        'dosisRecomendadaKgHa': 150.0,
        'descripcion': 'Alto fósforo para floración'
      },
      {
        'id': 'fer-006',
        ...
        'presentacion': 'Cristalino',
        'dosisRecomendadaKgHa': 200.0,
        'descripcion': 'Nitrógeno + azufre para suelos alcalinos'
      },
      {
        'id': 'fer-007',
        'nombre': 'Nitrato de potasio',
        'tipo': 'químico',
        'composicionNpk': '13-0-46',
        'presentacion': 'Cristalino',
        'dosisRecomendadaKgHa': 80.0,
        'descripcion': 'Fertirrigación, libre de cloro'
      },
      {
        'id': 'fer-008',
        'nombre': 'Cal dolomita',
        ...
        'presentacion': 'Polvo',
        'dosisRecomendadaKgHa': 1000.0,
        'descripcion': 'Corrector de pH, aporta Ca y Mg'
      },
      {
        'id': 'fer-009',
        'nombre': 'Gallinaza',
        'tipo': 'orgánico',
        'composicionNpk': '3-3-2',
        'presentacion': 'Sólido',
        'dosisRecomendadaKgHa': 2000.0,
        'descripcion': 'Abono orgánico de alta disponibilidad'
      },
      {
        'id': 'fer-010',
        'nombre': 'Compost',
        'tipo': 'orgánico',
        'composicionNpk': '1.5-1-1',
        'presentacion': 'Sólido',
        'dosisRecomendadaKgHa': 3000.0,
        'descripcion': 'Materia orgánica descompuesta'
      },
      {
        'id': 'fer-011',
        'nombre': 'Bocashi',
        'tipo': 'orgánico',
        'composicionNpk': '2-2-1',
        'presentacion': 'Sólido',
        'dosisRecomendadaKgHa': 2500.0,
        'descripcion': 'Abono fermentado japonés'
      },
      {
        'id': 'fer-012',
        ...
        'presentacion': 'Sólido',
        'dosisRecomendadaKgHa': 2000.0,
        'descripcion': 'Lombricompuesto, mejora estructura'
      },
      {
        'id': 'fer-013',
        ...
        'composicionNpk': '0-0-0',
        'presentacion': 'Polvo',
        'dosisRecomendadaKgHa': 15.0,
        'descripcion': 'Micronutriente para arroz y maíz'
      },
      {
        'id': 'fer-014',
        'nombre': 'Boro (Bórax)',
        ...
        'composicionNpk': '0-0-0',
        'presentacion': 'Polvo',
        'dosisRecomendadaKgHa': 10.0,
        'descripcion': 'Micronutriente para palma y frutales'
      },
      {
        'id': 'fer-015',
        'nombre': 'Fosforita Huila',
        'tipo': 'enmienda',
        'composicionNpk': '0-20-0',
        'presentacion': 'Polvo',
        'dosisRecomendadaKgHa': 500.0,
        'descripcion': 'Roca fosfórica de liberación lenta'
      },
    ];
    ...
    final tiposSuelo = [
      {
        ...
        'phTipico': 6.5,
        'cultivosRecomendados': 'Banano, Maíz, Hortalizas',
        'descripcion': 'Equilibrio ideal de arena, limo y arcilla'
      },
      {
        'id': 'sue-002',
        ...
        'clase': 'Clase III',
        'drenaje': 'Moderado',
        'retencionHumedadPct': 55.0,
        'phTipico': 6.2,
        'cultivosRecomendados': 'Arroz, Palma, Cacao',
        'descripcion': 'Alta retención de humedad y nutrientes'
      },
      {
        'id': 'sue-003',
        ...
        'phTipico': 6.8,
        'cultivosRecomendados': 'Yuca, Sandía, Melón',
        'descripcion': 'Buen drenaje, baja retención de agua'
      },
      {
        'id': 'sue-004',
        'nombre': 'Arcilloso',
        'clase': 'Clase IV',
        'drenaje': 'Lento',
        'retencionHumedadPct': 65.0,
        'phTipico': 5.8,
        'cultivosRecomendados': 'Arroz, Pastos',
        'descripcion': 'Alta retención pero difícil laboreo'
      },
      {
        'id': 'sue-005',
        'nombre': 'Arenoso',
        'clase': 'Clase V',
        'drenaje': 'Muy rápido',
        'retencionHumedadPct': 15.0,
        'phTipico': 7.0,
        'cultivosRecomendados': 'Coco, Marañón',
        'descripcion': 'Zonas costeras, requiere riego frecuente'
      },
      {
        'id': 'sue-006',
        'nombre': 'Aluvial',
        ...
        'descripcion': 'Suelos fértiles de llanuras de inundación'
      },
      {
        'id': 'sue-007',
        ...
        'descripcion': 'Zonas de ciénaga, alto contenido orgánico'
      },
      {
        'id': 'sue-008',
        'nombre': 'Vertisol',
        ...
        'phTipico': 7.2,
        'cultivosRecomendados': 'Algodón, Sorgo, Maíz',
        'descripcion': 'Arcillas expansivas, grietas en sequía'
      },
    ];
  ...
  Future<void> upsertCatalogo(
    ...
    for (final item in items) {
      ...
      if (data.containsKey('activo')) {
        data['activo'] =
            (data['activo'] == true || data['activo'] == 1) ? 1 : 0;
      }
