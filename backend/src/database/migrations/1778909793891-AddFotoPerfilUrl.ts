...
export class AddFotoPerfilUrl1778909793891 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0afd78a3c2cfd6b0f6c01125f6" ON "lotes" ("propietarioId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_fc8d97361c52561e9425a8a7da" ON "users" ("telefono") WHERE telefono IS NOT NULL AND "deletedAt" IS NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "lotes" ADD CONSTRAINT "FK_0afd78a3c2cfd6b0f6c01125f67" FOREIGN KEY ("propietarioId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_users_telefono_active" ON "users" ("telefono") WHERE ((telefono IS NOT NULL) AND ("deletedAt" IS NULL))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_users_email_active" ON "users" ("email") WHERE ("deletedAt" IS NULL)`);
        await queryRunner.query(`CREATE INDEX "IDX_lotes_propietario" ON "lotes" ("propietarioId") `);
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_audit_logs_actor" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lotes" ADD CONSTRAINT "FK_lotes_propietario" FOREIGN KEY ("propietarioId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
